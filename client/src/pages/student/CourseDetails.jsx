  ...
  return courseData ? (
    <>
      <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
        ...
        <div
          className='absolute top-0 left-0 w-full -z-[1] bg-gradient-to-b from-cyan-100/70 to-white'
          style={{ height: '500px' }}
        ></div>

        {/* left column */}
        <div className='max-w-xl z-10 text-gray-500'>
          <h1 className='md:text-4xl text-2xl font-semibold text-gray-800 mb-4'>{courseData.courseTitle}</h1>
          ...
          <p className='text-sm'>Course by <span className='text-blue-600 underline'>Ashish Sah</span></p>
                        ...
                        <li key={i} className='flex items-start gap-2 py-1'>
                          ...
                          <div className='flex items-center justify-between w-full text-gray-800 text-xs md:text-default'>
                            ...
                            <div className='flex gap-2'>
                              ...
                              <p>{humanizeDuration(lecture.lectureDuration * 60 * 100, { units: ['h', 'm'] })}</p>
                            </div>
                          </div>
                        </li>
                      ))}
        ...
        <div className='max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]' >
          ...
          <div className='p-5'>
            ...
            <div className='pt-6'>
              <p className='md:test-xl text-lg font-medium text-gray-800'>Whats in the course</p>
