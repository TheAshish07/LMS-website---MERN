      ...
      <div className='md:px-36 px-8 pt-10'>
        ...
        <table className='md:table-auto table-fixed w-full overflow-hidden border mt-10'>
          <thead className='text-gray-900 border-b border-gray-500/20 text-sm text-left max-sm:hidden'>
            <tr>
              <th className='px-4 py-3 font-semnibold truncate'>Course</th>
              <th className='px-4 py-3 font-semnibold truncate'>Duration</th>
              <th className='px-4 py-3 font-semnibold truncate'>Completed</th>
              <th className='px-4 py-3 font-semnibold truncate'>Status</th>
            </tr>
          </thead>
